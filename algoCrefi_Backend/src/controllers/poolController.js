...
const { submitSignedAppCall, getPoolInfo, getUserShares, getTotalShares, getBackendAddress } = require("../services/appService");
...
exports.deposit = async (req, res) => {
  try {
    ...
    const { txId, signedDepositTx } = req.body;
    ...
    const deposit = await Deposit.create({
      ...
      txId,
      appId: parseInt(process.env.POOL_APP_ID),
    });
